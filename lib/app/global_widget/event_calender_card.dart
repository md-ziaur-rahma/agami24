...
class EventCalenderCard extends StatelessWidget {
  EventCalenderCard({Key? key,this.index}) : super(key: key);
  final int? index;
        ...
        child: Column(
          ...
          children: [
            DecoratedBox(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: NetworkImage(AppStrings.event_forum1),fit: BoxFit.cover,
                ),
              ),
              child: Container(
                ...
                child: Center(
                    child: Container(
                      ...
                      child: const Text('Pediatric Forum',
            ...
            Container(
              ...
              width: double.infinity,
              child: Text('March 18 | Pediatric Forum',
                textAlign: TextAlign.start,
            ...
            Container(
              margin: const EdgeInsets.symmetric(horizontal: 16),
              width: double.infinity,
              child: const Text(AppStrings.eventCalenderText,maxLines: 3,overflow: TextOverflow.ellipsis,textAlign: TextAlign.start,style: TextStyle(fontSize: 14,fontWeight: FontWeight.normal,color: Colors.black54),),
            ),
            Align(
